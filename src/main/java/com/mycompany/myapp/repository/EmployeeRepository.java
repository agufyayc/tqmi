...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
    ...
    @Query(
        value = "select distinct employee from Employee employee left join fetch employee.cell",
    ...
    @Query("select distinct employee from Employee employee left join fetch employee.cell")
    List<Employee> findAllWithToOneRelationships();

    @Query("select employee from Employee employee left join fetch employee.cell where employee.id =:id")
