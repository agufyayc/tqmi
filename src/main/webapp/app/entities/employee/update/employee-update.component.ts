...
export class EmployeeUpdateComponent implements OnInit {
  ...
  compareCell = (o1: ICell | null, o2: ICell | null): boolean => this.cellService.compareCell(o1, o2);
  ...
  protected updateForm(employee: IEmployee): void {
    ...
    this.cellsSharedCollection = this.cellService.addCellToCollectionIfMissing<ICell>(this.cellsSharedCollection, employee.cell);
  }

  protected loadRelationshipsOptions(): void {
    this.cellService
      .query()
      .pipe(map((res: HttpResponse<ICell[]>) => res.body ?? []))
      .pipe(map((cells: ICell[]) => this.cellService.addCellToCollectionIfMissing<ICell>(cells, this.employee?.cell)))
      .subscribe((cells: ICell[]) => (this.cellsSharedCollection = cells));
  }
}
